...
async function analyzeTicketWithAI(ticketData) {
    ...
    try {
        const prompt = `أنت موظف في قولدن تيكت. العميل تواصل عبر الشات بوت واختار خيارات.

البلاغ: ${ticketData.subject || ''}

دليل الخيارات:
▸ شراء تذكرة,قبل الشراء,[فعالية] → يريد شراء تذكرة للفعالية المذكورة
▸ شراء تذكرة,بعد الشراء,فعالية إنتهت → اشترى تذكرة لفعالية انتهت ويحتاج مساعدة
▸ شراء تذكرة,بعد الشراء,فعالية قادمة → اشترى تذكرة لفعالية قادمة ويحتاج مساعدة
▸ شراء تذكرة,بعد الشراء,فعالية خارج السعودية → اشترى تذكرة لفعالية خارج السعودية

▸ بيع تذكرة,قبل البيع,عرض تذاكري للبيع → يسأل كيف يعرض تذاكره للبيع
▸ بيع تذكرة,قبل البيع,تذكرتي لم يتم قبولها → عرض تذكرته ولم تُقبل
▸ بيع تذكرة,قبل البيع,لا أرى تذكرتي معروضه → لا يجد تذكرته معروضة
▸ بيع تذكرة,قبل البيع,متى يصلني المبلغ → يسأل متى يستلم المبلغ
▸ بيع تذكرة,قبل البيع,التراجع عن البيع → يريد التراجع عن البيع
▸ بيع تذكرة,قبل البيع,ارسال التذكرة بعد البيع → يسأل كيف يرسل التذكرة

▸ بيع تذكرة,بعد البيع,كيفية ارسال التذاكر → باع ويسأل كيف يرسلها
▸ بيع تذكرة,بعد البيع,التراجع عن البيع → باع ويريد التراجع
▸ بيع تذكرة,بعد البيع,لم أستلم المبلغ → باع ولم يستلم المبلغ
▸ بيع تذكرة,بعد البيع,حالة التذكره لم يستلم → أرسل التذكرة لكن المشتري لم يستلمها
▸ بيع تذكرة,بعد البيع,اخرى → استفسار آخر

اكتب جملة مختصرة تشرح طلب العميل.
